      ...
      <div className="flex min-h-screen items-center justify-center bg-slate-950 px-4">
        <div className="w-full max-w-md rounded-2xl bg-slate-900 p-8 text-center ring-1 ring-white/10">
          ...
          <div className="mt-5 h-1.5 w-full overflow-hidden rounded-full bg-slate-800">
            <div className="h-full w-full animate-[grow_2.5s_linear_forwards] rounded-full bg-green-500" />
          </div>
        </div>
      </div>
    );
      ...
      <div className="w-full max-w-md">
        ...
        <form onSubmit={handleSubmit} className="rounded-2xl bg-slate-900 p-8 ring-1 ring-white/10 space-y-5">
          <div>
            ...
            <input
              type="password"
              placeholder="Enter the SETUP_SECRET from your server"
              value={secret}
            ...
            <p className="mt-1.5 text-xs text-slate-500">
              This is the <code className="text-slate-300">SETUP_SECRET</code> value from your <code className="text-slate-300">.env.local</code> file.
            </p>
          </div>
          ...
          <p className="text-center text-xs text-slate-500">
            You must be signed into the account you want to promote.
          </p>
        </form>
      </div>
    </div>

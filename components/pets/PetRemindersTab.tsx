...
const TYPE_CONFIG: Record<ReminderType, { label: string; emoji: string; pill: string }> = {
  VET_APPOINTMENT: { label: "Vet Appointment", emoji: "🏥", pill: "bg-blue-50 dark:bg-blue-900/20   text-blue-700   ring-blue-100" },
  MEDICATION:      { label: "Medication",       emoji: "💊", pill: "bg-purple-50 dark:bg-purple-900/20 text-purple-700 ring-purple-100" },
  GROOMING:        { label: "Grooming",         emoji: "✂️", pill: "bg-orange-50 text-orange-700 ring-orange-100" },
  VACCINATION:     { label: "Vaccination",      emoji: "💉", pill: "bg-teal-50   text-teal-700   ring-teal-100" },
